...
import com.android.internal.util.voltage.FullscreenTaskStackChangeListener;
...
public class VoltageSystemExService extends SystemService {

    private static final String TAG = "VoltageSystemExService";
    ...
    public VoltageSystemExService(Context context) {
        super(context);
    ...
    private void maybeCleanClonedUser(int userId) {
        ...
        if (!hasUserApp) {
            ...
            VoltageUtils.forceStopDefaultLauncher(getContext());
        }
    }
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            VoltageSystemExService.this.onPackageRemoved(packageName);
        }
