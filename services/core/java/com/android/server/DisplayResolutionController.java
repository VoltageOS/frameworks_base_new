...
import static com.voltage.view.DisplayResolutionManager.FHD_WIDTH;
import static com.voltage.view.DisplayResolutionManager.QHD_WIDTH;
import static com.voltage.view.DisplayResolutionManager.RESTART_SYSTEMUI_ON_SWITCH;
import static com.voltage.view.DisplayResolutionManager.SCALE;
import static com.voltage.view.DisplayResolutionManager.TYPE_AOSP_FHD_DEFAULT;
import static com.voltage.view.DisplayResolutionManager.TYPE_DISABLED;
import static com.voltage.view.DisplayResolutionManager.TYPE_FORCED;
...
import com.voltage.view.IDisplayResolutionListener;
...
public class DisplayResolutionController {
    ...
    private static final String PROP_SCALE_BOOTANIMATION =
            "persist.sys.voltage.bootanimation.scale";
    ...
    public void initSystemExService(VoltageSystemExService service) {
    ...
    public void systemReady() {
        ...
        if (overlayPkgList != null && overlayPkgList.length != 0) {
            for (String pkg : overlayPkgList) {
                if (VoltageUtils.isPackageInstalled(mContext, pkg)) {
    ...
    private void setResolutionInternal(int width, boolean onBoot) {
        ...
        applyOverlay(width == FHD_WIDTH);
        VoltageUtils.forceStopDefaultLauncher(mContext);
        if (RESTART_SYSTEMUI_ON_SWITCH) {
            VoltageUtils.restartSystemUi(mContext);
        }
