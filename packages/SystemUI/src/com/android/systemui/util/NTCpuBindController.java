...
public class NTCpuBindController {
    ...
    private static final String CPUS_PARAMS_BG_LIMIT = SystemProperties.get("persist.sys.voltage_cpu_limit_bg", "0-1");
    private static final String CPUS_PARAMS_UI_LIMIT = SystemProperties.get("persist.sys.voltage_cpu_limit_ui", "0-4");
    private static final String CPUS_PARAMS_UI_UNLIMIT = SystemProperties.get("persist.sys.voltage_cpu_unlimit_ui", "0-7");
    private static final String CPUS_PARAMS_FG_UNLIMIT = SystemProperties.get("persist.sys.voltage_cpu_fg", "0-5");
    private static final String CPUS_PARAMS_BG_UNLIMIT = SystemProperties.get("persist.sys.voltage_cpu_bg", "0-2");
    private static final String CPUS_PARAMS_SMALL_CORES = SystemProperties.get("persist.sys.voltage_cpu_small", "0,1,2,3");
