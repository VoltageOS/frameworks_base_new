...
class NTCpuBindController private constructor() {
    ...
    companion object {
        ...
        private val CPUS_PARAMS_BG_LIMIT = SystemProperties.get("persist.sys.voltage_cpu_limit_bg", "0-1")
        private val CPUS_PARAMS_UI_UNLIMIT = SystemProperties.get("persist.sys.voltage_cpu_unlimit_ui", "0-7")
        private val CPUS_PARAMS_SMALL_CORES = SystemProperties.get("persist.sys.voltage_cpu_small", "0,1,2,3")
