...
class AnimationScaleTile @Inject constructor(
...
), AnimationScaleController.AnimationScaleListener {
    ...
    override fun handleUpdateState(state: BooleanState, arg: Any?) {
        val isActive = controller.isAnimationsOn
        ...
        val currentLabel = controller.getCurrentLabel()
        state.secondaryLabel = currentLabel.replace("Speed • ", "")
