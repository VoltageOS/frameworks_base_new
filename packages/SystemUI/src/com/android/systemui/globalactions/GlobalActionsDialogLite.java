...
import static com.android.internal.util.voltage.PowerMenuConstants.*;
...
public class GlobalActionsDialogLite implements DialogInterface.OnDismissListener,
    ...
    protected void createActionItems() {
        ...
        if (mLineageGlobalActions != null &&
                mLineageGlobalActions.userConfigContains(GLOBAL_ACTION_KEY_RESTART_SYSTEMUI)) {
    ...
    static class ActionsDialogLite extends SystemUIDialog implements DialogInterface,
        ...
        ActionsDialogLite(Context context,
            ...
            mSelectedUserInteractor = selectedUserInteractor;
            mBlurUtils = new BlurUtils(mContext.getResources(), mContext.getContentResolver());
        }
